...
class AABBWrapper
{
  public:
    ...
    AABBWrapper(const GEO::Mesh& sf_mesh)
        : sf_mesh(sf_mesh)
        , sf_tree(sf_mesh)
    {}
    ...
    inline void init_sf_tree(const std::vector<Vector3>&  vs,
    ...
    inline bool is_out_sf_envelope(const std::vector<GEO::vec3>& ps,
                                   const Scalar                  eps_2,
    ...
    inline bool is_out_b_envelope(const std::vector<GEO::vec3>& ps,
                                  const Scalar                  eps_2,
                                  GEO::index_t                  prev_facet = GEO::NO_FACET) const
    {
        GEO::vec3 nearest_point;
    ...
    inline bool is_out_tmp_b_envelope(const std::vector<GEO::vec3>& ps,
                                      const Scalar                  eps_2,
                                      GEO::index_t prev_facet = GEO::NO_FACET) const
    {
        GEO::vec3 nearest_point;
    ...
    inline bool is_out_sf_envelope(const Vector3& p,
                                   const Scalar   eps_2,
    ...
    inline bool is_out_sf_envelope(const GEO::vec3& geo_p,
                                   const Scalar     eps_2,
                                   GEO::index_t&    prev_facet,
                                   double&          sq_dist,
                                   GEO::vec3&       nearest_p) const
    ...
    inline bool is_out_b_envelope(const Vector3& p,
                                  const Scalar   eps_2,
                                  GEO::index_t&  prev_facet) const
    {
        GEO::vec3 nearest_p;
    ...
    inline bool is_out_tmp_b_envelope(const Vector3& p,
                                      const Scalar   eps_2,
                                      GEO::index_t&  prev_facet) const
    {
        GEO::vec3 nearest_p;
    ...
    // fortest
    inline Scalar dist_sf_envelope(const std::vector<GEO::vec3>& ps,
                                   const Scalar                  eps_2,
                                   GEO::index_t                  prev_facet = GEO::NO_FACET) const
