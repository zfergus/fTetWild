...
// floatTetWild::Scalar *pb, const floatTetWild::Scalar *pc, const floatTetWild::Scalar *pd); extern
// "C" floatTetWild::Scalar orient2d(const floatTetWild::Scalar *pa, const floatTetWild::Scalar *pb,
// const floatTetWild::Scalar *pc);
...
int Predicates::orient_3d(const Vector3& p1,
                          const Vector3& p2,
                          const Vector3& p3,
                          const Vector3& p4)
{
...
int Predicates::orient_3d_tolerance(const Vector3& p1,
                                    const Vector3& p2,
                                    const Vector3& p3,
                                    const Vector3& p)
{
...
Scalar Predicates::orient_3d_volume(const Vector3& p1,
                                    const Vector3& p2,
                                    const Vector3& p3,
                                    const Vector3& p4)
{
