...
if(TARGET ftetwild::warnings)
  return()
endif()

set(FTETWILD_WARNING_FLAGS
    -Wall
    -Wextra
    -pedantic
...
add_library(ftetwild_warnings INTERFACE)
add_library(ftetwild::warnings ALIAS ftetwild_warnings)

include(ftetwild_filter_flags)
ftetwild_filter_flags(ftetwild_WARNING_FLAGS)
target_compile_options(ftetwild_warnings INTERFACE ${FTETWILD_WARNING_FLAGS})
