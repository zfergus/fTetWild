...
if("${CMAKE_CXX_COMPILER_ID}" STREQUAL "MSVC")
  ...
  set(FTETWILD_GLOBAL_FLAGS
      -fdiagnostics-color=always # GCC
      -fcolor-diagnostics # Clang
  )
  ftetwild_filter_flags(ftetwild_GLOBAL_FLAGS)
  message(STATUS "Adding global flags: ${FTETWILD_GLOBAL_FLAGS}")
  add_compile_options(${FTETWILD_GLOBAL_FLAGS})
endif()
